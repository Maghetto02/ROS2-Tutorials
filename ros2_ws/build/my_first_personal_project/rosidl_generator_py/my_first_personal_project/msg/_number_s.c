...
bool my_first_personal_project__msg__number__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_first_personal_project.msg._number.Number", full_classname_dest, 44) == 0);
  }
  my_first_personal_project__msg__Number * ros_message = _ros_message;
  {  // node_id
...
PyObject * my_first_personal_project__msg__number__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_first_personal_project.msg._number");
