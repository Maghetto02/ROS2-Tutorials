...
static const _Number_type_support_symbol_names_t _Number_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_first_personal_project, msg, Number)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_first_personal_project, msg, Number)),
  }
};
...
{
  return &::my_first_personal_project::msg::rosidl_typesupport_cpp::Number_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_first_personal_project, msg, Number)() {
  return get_message_type_support_handle<my_first_personal_project::msg::Number>();
}
