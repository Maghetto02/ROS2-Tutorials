...
{
bool cdr_serialize(
  const my_first_personal_project::msg::String &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  my_first_personal_project::msg::String &);
...
{
  // Member: pid
  my_first_personal_project::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.pid,
    cdr);
  // Member: number
...
{
  // Member: pid
  my_first_personal_project::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.pid);
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    my_first_personal_project::msg::typesupport_fastrtps_cpp::get_serialized_size(
    ros_message.pid, current_alignment);
  // Member: number
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: pid
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        my_first_personal_project::msg::typesupport_fastrtps_cpp::max_serialized_size_String(
